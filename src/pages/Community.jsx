...
// const SHEET_URL =
//   "https://api.sheety.co/b9d6377217c0f00eab5cf85582e4a378/skillswap/community";
...
//       setPosts(res.data?.community?.reverse() || []);
//     } catch (err) {
//       console.error("Sheety error:", err?.response?.status);

//       if (err?.response?.status === 402) {
//         setError("Community service temporarily unavailable");
//       } else {
...
//       fetchPosts();
//     } catch {
//       alert("Posting is disabled right now");
//     }
//   };

//   const handleLike = async (post) => {
//     try {
//       await sheety.put(`/${post.id}`, {
//         community: { likes: post.likes + 1 },
//       });
...
//     try {
//       await sheety.put(`/${post.id}`, {
//         community: { comments: post.comments + 1 },
//       });
...
//             <MentorCard name="Lena Müller" role="Product Strategy" />
